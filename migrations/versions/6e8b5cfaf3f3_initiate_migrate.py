...
Revision ID: 6e8b5cfaf3f3
Revises: 6b28d4581086
Create Date: 2019-12-25 11:00:46.289299
...
revision = '6e8b5cfaf3f3'
down_revision = '6b28d4581086'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.Column('nbrlikes', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['user_id'], ['user.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
